package com.kinstalk.her.setupwizard.view.adapter;
...
import com.kinstalk.her.setupwizard.util.Utility;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by pop on 17/5/16.
 */
...
public class WifiListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(HerSetupWizardApplication.getApplication()).inflate(R.layout.item_wifilist_content, null, false);
