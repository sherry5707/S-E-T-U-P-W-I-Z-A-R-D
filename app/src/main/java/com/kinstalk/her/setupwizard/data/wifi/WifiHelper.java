...
public class WifiHelper {
    ...
    private WifiHelper() {
        wifiManager = (WifiManager) HerSetupWizardApplication.getApplication().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
    }
    ...
    /**
     * 保存Wifi账号密码到Setting APK的SharedPreference中
     * @param ssid
     * @param passwd
     * @return
     */
    ...
    public void saveWIFI(String ssid,String passwd){
        ContentResolver resolver = HerSetupWizardApplication.getApplication().getContentResolver();
    ...
    public boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) HerSetupWizardApplication.getApplication().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
