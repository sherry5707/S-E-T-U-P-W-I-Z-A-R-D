...
public class GuideXiaoWeiActivateFailFragment extends Fragment{
    ...
    public static GuideXiaoWeiActivateFailFragment getInstance() {
        return new GuideXiaoWeiActivateFailFragment();
    }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.try_again) {
            ...
            if(parentActivity != null) {
                ((HerBootGuideXiaoWeiActivity)parentActivity).tryUnbindAgain();
            }
