...
public class Constants {
    ...
    public static final String KINSTALK_QCHAT_BIND_STATUS = "com.kinstalk.her.qchat.bind_status";
    public static final String EXTRA_QCHAT_BIND_STATUS = "qchat.bind_status";
    public static final String KINSTALK_QCHAT_QRCODE_READY = "com.kinstalk.her.qchat.qrcode";
    public static final String ACTION_ASSIST_KEY ="com.kinstalk.action.assistkey";
